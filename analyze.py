...
tuition per region, in nominal USD and PPP-adjusted USD. Writes ``summary.csv`` and
...
METRICS = [
    ("annual_tuition_usd", "USD (nominal)"),
    ("annual_tuition_usd_ppp", "USD (PPP-adjusted)"),
]
...
def print_verdict(summary: list[dict]) -> None:
    nominal = {r["region"]: r for r in summary if r["metric"] == "USD (nominal)"}
