...
GROUP_STYLE = {
    countries.UK: {"color": "#e6194B", "lw": 2.6, "alpha": 1.0, "zorder": 5},
    countries.EU: {"color": "#4363d8", "lw": 1.0, "alpha": 0.45, "zorder": 2},
    countries.US: {"color": "#3cb44b", "lw": 1.6, "alpha": 0.9, "zorder": 4},
}
