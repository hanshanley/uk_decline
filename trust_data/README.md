...
> **Provenance guarantee.** The production pipeline reads the live OWID/OECD file directly.
> The retained historical snapshot can still be audited against the same source:
>
> ```bash
