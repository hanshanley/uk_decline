...
from . import charts, fetch, parse, summary
from .sources import CALENDAR_SOURCE, DATA_DIR, MIDYEAR_SOURCE, OUTPUT_DIR, RAW_DIR
...
def main(argv: list[str] | None = None) -> int:
    ...
    for path in charts.make_charts(annual, midyear, args.outputs_dir):
